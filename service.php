...
<body>
    ...
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="bd_orthodonticsTitle">ORTHODONTICS</h5>
        ...
        <div class="modal-body">
          ...
          <div class="right-bar-categories">
            ...
            <strong>Preventive &amp; interceptive Orthodontics :</strong> <br>
            &rArr; Maintenance of deciduous dentition <br>
            &rArr; Guiding eruption of permanent teeth<br>
            &rArr; Oral Habit correction, viz. Thumb Sucking, Tongue Thrushing, Nail Biting etc.<br>
            &rArr; Myofunctional appliances (Growth modification)<br>
            &rArr; Jaw correction appliances<br><br>
            <strong>Fixed Mechanotherapy with straight wire technique (internationally accepted and practised :</strong> <br>
            &rArr; Stainless Steel Braces<br>
            &rArr; Ceramic Braces<br>
            &rArr; Self Ligating Braces<br>
            &rArr; Gold Braces<br>
            Micro-implant screw for absolute anchorage
            Interdisciplinary Orthodontics - Aesthetic Orthodontics
            Orthodontics without wire, viz. Head Gears, Clear Path, Aligners etc.
          </div>
        </div>
      </div>
    </div>
  </div>
  <!-- Content for ORTHODONTICS learn more  ends here -->

  <!-- Content for endodontics learn more start here-->
  <div class="modal fade bd_endodontics" tabindex="-1" role="dialog" aria-labelledby="bd_endodonticsLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="bd_endodonticsTitle">ENDODONTICS</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          ...
          <div class="right-bar-categories">
            ...
            &rArr; Deep Caries that has involved the Pulp of the tooth.<br>
            &rArr; Severe attrition of teeth that causes sensitivity in the tooth.<br>
            &rArr; Traumatic injury to the tooth causing Fracture and/or Pulp exposure.<br>
            &rArr; Severe modification of the tooth which will comprise the vitality of the tooth.<br>
            &rArr; Badly broken tooth that needs to be restored with the help of post and core buildup.<br>
            <strong>Advancement of RCT Procedure : </strong> <br>
            &rArr; With the use of Hands or Rotary Endodontic system that enables one to complete most RCTs in a short span of time.<br>
            &rArr; All the procedures can be confirmed for accuracy with the help of the RVG (Radiovisuography), i.e. Digital X-Ray imaging system along with Apex Locators<br>
            &rArr; The filling of the root canals after cleaning procedure with the use of Inert Sterilized Gutta Percha (GP) system which ensures complete obturation of the cleaned root canal in a three dimensional Hermetic Seal<br>
            &rArr; Root Canal Treatment with the assistance of Surgical Magnification devices to ensure better visibility to the operator and thereby ensures better prognosis of the tooth treated<br>
            <strong>Services Provided : </strong> <br>
            &rArr; Single Sitting Root Canal Treatment. <br>
            &rArr; Laser Assisted Root Canal Treatment. <br>
            &rArr; Re-Root Canal Treatment — It is required when the RCT has been done elsewhere but failed or not done properly causing recurring pain and infection. <br>
            &rArr; RCT of medically compromised patients, viz. patients on anti-coagulants.<br>
            &rArr; RCT of 3rd Molar Tooth (Wisdom Tooth).<br>
          </div>
        </div>
      </div>
    </div>
  </div>
  <!-- Content for endodontics learn more ends here-->

  <!-- Content for PERIODONTICS  learn more start here-->
  <div class="modal fade bd_periodontics" tabindex="-1" role="dialog" aria-labelledby="bd_periodonticsLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="bd_periodonticsTitle">PERIODONTICS</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          ...
          &rArr; Esthetic smile enhancing procedure and esthetic crown lengthening surgery. <br>
          &rArr; Reconstruction flap surgeries using bone graft materials and GTR membranes. <br>
        </div>
      </div>
    </div>
  </div>
  <!-- Content for PERIODONTICS learn more ends here-->

  <!-- Content for ORAL PATHOLOGY  learn more start here-->
  <div class="modal fade bd_oralpath" tabindex="-1" role="dialog" aria-labelledby="bd_oralpathLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <div class="modal fade bd_paedodontics" tabindex="-1" role="dialog" aria-labelledby="bd_paedodonticsLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="bd_paedodonticsTitle">PAEDODONTICS</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
  ...
  <div class="modal fade bd_cosmetic" tabindex="-1" role="dialog" aria-labelledby="bd_cosmeticLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="bd-cosmeticTitle">COSMETIC DENTISTRY</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
  ...
  <!-- Content for COSMETIC DENTISTRY learn more ends here-->

  <!-- Content for LASER DENTISTRY learn more start here-->
  <div class="modal fade bd_laser" tabindex="-1" role="dialog" aria-labelledby="bd_laserLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="bd_laserTitle">LASER DENTISTRY</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          ...
          &rArr; Smile improvements, i.e. Gum Sculpting that lengthens teeth due to oversized gingiva (improvement of ‘Gummy Smile’)<br>
          &rArr; Gingivectomy, Gingivoplasty, Crown Lengthening and other gum corrections<br>
          &rArr; Frenectomy (’tongue-tie’ release, orthodontic or periodontal indications) without anesthesia or sutures<br>
          &rArr; Cold sore treatments, Apthous Ulcer (’Canker Sore’) treatments<br>
          &rArr; Surgical measures for growth of different Soft Tissues in oral cavity <br>
          &rArr; Helps in coagulation (clotting) of blood<br>
          &rArr; Post Tooth extraction Laser Therapy — It helps in quick and better healing with minimum pain and swelling. <br>
          &rArr; Desensitization of Teeth <br>
          &rArr; Bleaching <br>
          &rArr; Pain Relief of Cheek Muscles and Joints by L.L.L.T. (Low Level Laser Therapy) <br><br>
        </div>
      </div>
    </div>
  </div>
  <!-- Content for LASER DENTISTRY learn more ends here-->

  <!-- Content for DENTAL X-RAY learn more start here-->
  <div class="modal fade bd_xray" tabindex="-1" role="dialog" aria-labelledby="bd_xrayLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <!-- Content for DENTAL X-RAY learn more ends here-->

  <!-- Content for ORAL & MAXILLO-FACIAL SURGERY learn more start here-->
  <div class="modal fade bd_oralmax" tabindex="-1" role="dialog" aria-labelledby="bd_oralmaxLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <!-- Content for ORAL & MAXILLO-FACIAL SURGERY learn more ends here-->

  <!-- Content for PROSTHODONTICS & IMPLANTOLOGY learn more start here-->
  <div class="modal fade bd_prosthodontics" tabindex="-1" role="dialog" aria-labelledby="bd_prosthodonticsLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="bd_prosthodonticsTitle">PROSTHODONTICS & IMPLANTOLOGY</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          ...
          &rArr; Cosmetic Smile Designing.<br> <br>
          <strong>Treatments provided under Dental Implants : </strong> <br>
          &rArr; Keyhole Implant.<br>
          &rArr; Single Tooth Implant.<br>
          &rArr; Multiple Teeth Implant.<br>
          &rArr; Full Mouth Reconstruction.<br>
          &rArr; All-on-4.<br>
          &rArr; Overdentures.<br>
          &rArr; Computer-guided Implant.<br>
          &rArr; Sinus Augmentation.<br>
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    $('.bd_orthodotics').on('shown.bs.modal', function() {
      $('.bd_orthodotics').trigger('focus')
    })
    $('.bd_cosmetic').on('shown.bs.modal', function() {
      $('.bd_cosmetic').trigger('focus')
    })
    $('.bd_endodontics').on('shown.bs.modal', function() {
      $('.bd_endodontics').trigger('focus')
    })
  </script>
</body>
